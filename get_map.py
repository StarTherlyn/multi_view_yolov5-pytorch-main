...
if __name__ == "__main__":
    ...
    image_ids = open(os.path.join(VOCdevkit_path, "VOC2007/ImageSets/Main/val_tv.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        for index, annotation_line in enumerate(tqdm(val_tv_lines)):
            line = annotation_line.split()
            img_name = line[0].split('/')[-1]
            line_add = val_sv_lines[index]
            ...
            yolo.get_map_txt(image_id, image, image_add, class_names, map_out_path)
